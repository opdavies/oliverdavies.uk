...
export async function get() {
  ...
  const callToAction = (emailBody) => {
    ...
    return '<br />P.S. ' + _.sample([
      'Are you still using Drupal 7 and don’t know what’s involved to upgrade to Drupal 10? <a href="https://www.oliverdavies.dev/call">Book a Drupal 7 upgrade consultation call</a>.',
